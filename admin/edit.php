...
$cururl="edit.php?type=".$_GET['type']."&file=".urlencode($_GET['file']);
...
if ( isset( $_POST['filedata'] ) )
{
	...
	copy ($prefix.urlencode($_GET['file']),"../revisions/".urlencode($_GET['file']).$time);
...
{
	$name = "../revisions/".urlencode($_GET['revision']);
	$file = fopen($name,"r");
	$filedata = fread($file, filesize($name));
	fclose($file);
}
